...
class Service:
    ...
    def __init__(self, domain: Union[str, Domain] = "", sub_topic_domains: Dict[str, str] = {}, pub_topic_domains: Dict[str, str] = {},
                 ds_host_addr: str = "127.0.0.1", sub_port: int = 10030, pub_port: int = 10031, protocol: str = "tcp",
...
class DialogSystem:
    ...
    def __init__(self, services: List[Union[Service, RemoteService]], sub_port: int = 10030, pub_port: int = 10031,
                 reg_port: int = 10032, protocol: str = 'tcp', debug_logger: DiasysLogger = None):
        """
        Args:
